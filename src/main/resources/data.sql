...
VALUES (1, '¿En qué año estamos?'),
       ...
       (2, 'Escuche atentamente el siguiente audio y repita las palabras por el micrófono. Solo podrá reproducirlo 3 veces.\n\nUtilice el botón izquierdo para reproducir y el derecho para hablar'),
