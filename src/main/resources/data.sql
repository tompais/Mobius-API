...
VALUES (1, '¿En qué año estamos?'),
       ...
       (2, 'Escuche atentamente el siguiente audio y repita las palabras por el micrófono. Solo podrá reproducirlo 3 veces.<br/><br/>Utilice el botón izquierdo para reproducir y el derecho para hablar'),
       (3, 'Cuente de 7 en 7 hacia atrás, partiendo del número 100, 5 veces'),
       (4, 'Deletree la palabra MUNDO al revés'),
       (5, '¿Puede recordar las 3 palabras del segundo juego?'),
