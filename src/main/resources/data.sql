...
VALUES (2, 'AUDIO', 'Bicicleta-Cuchara-Manzana.mp3'),
       ...
       (19, 'IMAGE', 'Lobo.jpg'),
       (20, 'AUDIO', 'Corona-Cerveza-Caja.mp3'),
       (21, 'AUDIO', 'Libro-Vaso-Cuaderno.mp3'),
       (22, 'AUDIO', 'Pelota-Raqueta-Árbitro.mp3'),
       (23, 'AUDIO', 'Atún-Naranja-Adorno.mp3'),
       (24, 'AUDIO', 'Carbón-Ventilador-Pájaro.mp3'),
...
VALUES (1, 'Bicicleta'),
       ...
       (130, 'Monitor'),
       (131, 'Ratón'),
       (132, 'El burrito barrigón ayer se dio un resbalón'),
       (133, 'Pepe pela patatas para una tortilla y para la ensalada'),
       (134, 'Los cojines de la reina las gemas del sultán');
